...
Pony::Pony( void ){
	Pony::counter++;
	std::cout<<"Pony №"<<Pony::counter<<" rised!"<<std::endl;
}

Pony::~Pony( void ){
	std::cout<<"Pony №"<<Pony::counter<<" gonna die!😈"<<std::endl;
	Pony::counter--;
}

void	Pony::call_rainbow( int i ) const{
	...
	std::cout<<"\033[0m Pony №"<<i<<" calling rainbow"<<std::endl;
	return ;
}